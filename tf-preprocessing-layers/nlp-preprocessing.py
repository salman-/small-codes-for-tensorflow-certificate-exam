...
from tensorflow.keras.layers import TextVectorization, Embedding, Input, GlobalAveragePooling1D, Dense, LSTM, GRU, \
    Bidirectional, Conv1D, GlobalMaxPool1D
...
train_sentences, test_sentences, train_labels, target_labels = train_test_split(train_df['text'], train_df['target'],
